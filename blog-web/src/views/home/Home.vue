          ...
          <div class="article-wrapper">
            <div style="line-height:1.4">
              <div>
                ...
                <span v-if="item.quantity >= 1000 && item.quantity < 10000" style="font-size:12px;border-radius:3px;border: 1px solid  #f70;text-align: center"><font style="color: #f70;">千次阅读</font></span>
                <span v-if="item.quantity >= 10000" style="font-size:12px;border-radius:3px;border: 1px solid  #f70;text-align: center"><font style="color: #f70;">万次阅读</font></span>
              </div>
            </div>
...
<!--                <li class="qqGroup">
                ...
                <li  v-if="isShowSocial(2)" class="qq"><a :href="'tencent://AddContact/?fromId=50&fromSubId=1&subcmd=all&uin=' +  blogInfo.webSite.qqNumber" target="_blank">{{blogInfo.webSite.qqNumber}}</a></li>
                <li  v-if="isShowSocial(1)" class="email"><a href="javascript:void(0);">{{blogInfo.webSite.email}}</a></li>
                <li  v-if="isShowSocial(3)" class="github"><a :href="blogInfo.webSite.github"  target="_blank">{{blogInfo.webSite.github}}</a></li>
                <li  v-if="isShowSocial(4)" class="gitee"><a :href="blogInfo.webSite.gitee" target="_blank">{{blogInfo.webSite.gitee}}</a></li>
